...
module.exports = (client) => {
    ...
    client.on('message', (msg) => {
        ...
        if (msg.content.startsWith(prefix+"report") || msg.content.startsWith(prefix+"raport") || msg.content.startsWith(prefix+"zglos") || msg.content.startsWith(prefix+"zgłoś") || msg.content.startsWith(prefix+"zgloś") || msg.content.startsWith(prefix+"zgłoś")) {} else if (msg.content.startsWith(prefix+"art") && msg.channel.id !== "723107790393966594" && author.id !== owner) {
            return msg.reply(`Poleceń możesz używać na kanele <#723107790393966594>!`);
        } else if (msg.content.startsWith(prefix+"art") && msg.channel.id === "723107790393966594" && author.id !== owner) {} else if (msg.channel.id !== botCommandsChannel && author.id !== owner && msg.content !== prefix) return msg.reply(`Poleceń możesz używać na kanele <#${botCommandsChannel}>!`);
